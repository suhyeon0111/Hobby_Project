...
----
[❗] 모든 request body의 필드는 누락되면 안됩니다.
----
...
.request url
----
DELETE /api/story/like?id={storyId}
----
.response body
include::{snippets}/story-dislike-request/response-body.adoc[]
...
----
.request body
include::{snippets}/story-reply-request/request-body.adoc[]
.response body
include::{snippets}/story-reply-request/response-body.adoc[]

=== 스토리 댓글 삭제
.request url
----
DELETE /api/story/reply?storyId={storyId}&replyId={replyId}
----
.response body
